  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-20 text-center">
      ...
      >
        ...
        <h1 className="text-4xl md:text-6xl font-bold mb-4">¡Pago Exitoso!</h1>
        <p className="text-xl text-muted-foreground">
          Gracias por tu compra. Tu entrada a los Latin American Leaders Awards ha sido confirmada.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 text-left">
        <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
          ...
          <h3 className="font-bold mb-2">Entrada enviada</h3>
          <p className="text-sm text-gray-400">
            Hemos enviado un correo con los detalles de tu registro y tu comprobante de pago.
          </p>
        </div>
        <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
          ...
          <p className="text-sm text-gray-400">
            Pronto recibirás nuestra guía logística exclusiva con recomendaciones de hoteles y transporte.
          </p>
        </div>
      </div>
