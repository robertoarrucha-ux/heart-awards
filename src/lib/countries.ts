export const countries = [
  ...
  "Dinamarca", "Dominica", "Yibuti",
  "Ecuador", "Egipto", "El Salvador", "Emiratos Árabes Unidos", "Eritrea", "Eslovaquia", "Eslovenia", "España", "Estados Unidos", "Estonia", "Etiopía", "Esuatini",
  ...
  "Kazajistán", "Kenia", "Kirguistán", "Kiribati", "Kuwait", "Kosovo",
  ...
  "Reino Unido", "República Centroafricana", "República Checa", "República de Macedonia del Norte", "República del Congo", "República Democrática del Congo", "República Dominicana", "Ruanda", "Rumanía", "Rusia",
