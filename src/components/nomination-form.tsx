...
const MAX_PHOTO_SIZE = 0.7 * 1024 * 1024; // 700KB to be safe with base64 overhead
...
const formSchema = z.object({
  ...
  profilePhoto: z
    ...
    .refine((files) => files === undefined || files.length === 0 || files?.[0]?.size <= MAX_PHOTO_SIZE, `El tamaño máximo de la foto es 700KB.`)
    .refine(
