...
export default function MediaPartners() {
  ...
  const mediaPartners = [
    ...
    { name: "LAI", logo: getLogoUrl("LAI-Logo.webp"), url: "https://lai.org" },
    ...
    { name: "Ban Ki-moon Centre", logo: getLogoUrl("Bank-Ki-Moon-Logo_525_1 Logo.webp"), url: "https://bankimooncenter.org" },
